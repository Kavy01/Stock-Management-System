...
public class DBConnection {
    ...
    static
    {
        try
        {
            ...
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//Karv-2000:1521/xe", "stockmanagement" , "emart");
    ...
    public static void closeConnection()
    {
        ...
        {
            conn.close();
            JOptionPane.showMessageDialog(null, "Connection closed Succesfullu", "Success", JOptionPane.INFORMATION_MESSAGE);
        }
        catch(SQLException ex)
        {
